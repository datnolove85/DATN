    ...
    <div class="space-y-3 overflow-hidden">
      ...
      <div class="space-y-2 overflow-hidden">
          ...
          >
            ...
            <div class="flex items-center gap-1.5">
              ...
              <span
                ...
                >{{ formatDate(brand.ngayCapNhat) }}</span
              >
            </div>
          </div>
        ...
        >
          ...
          <p class="text-slate-700 font-bold text-sm tracking-wide">Kho lưu trữ trống rỗng</p>
          <p class="text-xs text-slate-400 mt-0.5">Vui lòng khởi tạo thương hiệu đối tác mới.</p>
        </div>
      </div>
    </div>
...
const deleteBrand = async (id: number | null): Promise<void> => {
  if (id === null) return
  if (confirm('Xác nhận xóa thương hiệu này khỏi hệ thống?')) {
