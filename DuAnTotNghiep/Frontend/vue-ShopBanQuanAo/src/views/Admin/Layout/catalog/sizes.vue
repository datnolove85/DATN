  ...
  >
    ...
    <div class="space-y-3 overflow-hidden">
      ...
      >
        ...
        <div class="col-span-3 px-4 border-r border-slate-200">Tên kích cỡ</div>
      ...
      <div class="space-y-2">
        ...
        >
          <p class="text-slate-700 font-bold text-sm">Kho lưu trữ kích cỡ trống rỗng</p>
        </div>
      </div>
    </div>
      ...
      >
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
          <input
            ...
            placeholder="Mã kích cỡ (VD: XL, 42)"
