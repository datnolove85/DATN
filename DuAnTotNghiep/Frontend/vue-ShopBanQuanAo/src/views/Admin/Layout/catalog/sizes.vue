  ...
  >
    ...
    <div class="space-y-3 overflow-hidden">
      ...
      >
        ...
        <div class="col-span-3 px-4 border-r border-slate-200">Mã kích cỡ</div>
        <div class="col-span-4 px-4 border-r border-slate-200">Tên kích cỡ</div>
        <div class="col-span-3 text-center border-r border-slate-200">Trạng thái</div>
      ...
      <div class="space-y-2">
        ...
        >
          ...
          <div
            class="col-span-3 flex items-center gap-2 md:gap-0 md:px-4 md:border-r md:border-slate-200 h-full transition-colors duration-300 group-hover:border-indigo-200"
          >
          ...
          <div
            class="col-span-4 text-sm font-bold text-slate-800 group-hover:text-indigo-600 transform transition-all duration-300 ease-out capitalize truncate md:px-4 md:border-r md:border-slate-200 h-full flex items-center group-hover:translate-x-1.5"
          >
            {{ size.tenKichThuoc }}
          </div>

          <div
            class="col-span-3 flex md:justify-center items-center gap-2 md:gap-0 md:border-r md:border-slate-200 h-full transition-colors duration-300 group-hover:border-indigo-200"
          >
        ...
        >
          ...
          <p class="text-slate-700 font-bold text-sm tracking-wide">
            Kho lưu trữ kích cỡ trống rỗng
          </p>
          <p class="text-xs text-slate-400 mt-0.5">Vui lòng tạo cấu hình kích cỡ sản phẩm mới.</p>
        </div>
      </div>
    </div>
        ...
        <form @submit.prevent="handleSubmit" class="p-6 space-y-5">
          ...
          <div class="space-y-1.5">
            ...
            <input
              ...
              placeholder="Nhập tên mô tả kích cỡ..."
              required
            />
          </div>
...
const deleteSize = async (id) => {
  if (confirm('Bạn có chắc muốn xóa kích cỡ này khỏi hệ thống?')) {
    try {
